...
@DisplayName("xxx - Submeter Avaliação")
@ExtendWith(TestWatcher.class)

public class AvalicaoSubmeter {
  ...
  void execute(String xxxlicationURL) throws Exception {
	    ...
	    // 7. Is 'Editar Avaliação' visible?
	    GeneratedUtils.sleep(5500);
	    by = By.xpath("//a[normalize-space()='Editar Avaliação']");
	    driver.findElement(by).isDisplayed();
	    
	    // 8. Click 'Editar Avaliação'
	    GeneratedUtils.sleep(500);
	    by = By.xpath("//a[normalize-space()='Editar Avaliação']");
	    driver.findElement(by).click();
	    ...
	    // 9. Click 'MenuAVL'
	    GeneratedUtils.sleep(500);
	    by = By.xpath("//*/x-xxx-complaints-process/x-xxx-complaint/x-xxx-complaints-evaluation/xxx-sidebar-container/xxx-sidebar/aside/perfect-scrollbar/div/div[1]/div/div/xxx-sidebar-body/div[1]/div/div/xxx-xxx-menu/div/div/div/img");
	    driver.findElement(by).click();
	    ...
	    // 11. Is 'Estado Em Despacho' visible?
	    GeneratedUtils.sleep(5500);
